...
CREATE TABLE CartItem (
    ...
    PackageType NVARCHAR(10) NULL, -- 'UNIT' | 'PACK' | 'BOX' | 'KG'
    PackSize INT NULL, -- for PACK
    UnitPrice DECIMAL(18,2) NULL, -- price per selected package at add time
    DisplayUnitName NVARCHAR(100) NULL,
