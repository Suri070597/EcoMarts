<%-- 
    Document   : create-supplier
    Created on : Jun 17, 2025, 9:53:39 PM
    Author     : ADMIN
--%>
                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/admin/supplier" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="status" id="status" required>
                                <option value="1" ${param.status eq '1' ? 'selected' : ''}>Cooperation</option>
                                <option value="0" ${param.status eq '0' ? 'selected' : ''}>In Cooperation</option>
                            </select>
