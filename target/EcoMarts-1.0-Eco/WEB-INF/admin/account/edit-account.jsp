                                ...
                                <form method="POST" action="${pageContext.request.contextPath}/admin/account"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="gender" id="gender">
                                            <option value="Nam" ${account.gender eq 'Nam' ? 'selected' : '' }>Nam
                                            </option>
                                            <option value="Nữ" ${account.gender eq 'Nữ' ? 'selected' : '' }>Nữ</option>
                                            <option value="Khác" ${account.gender eq 'Khác' ? 'selected' : '' }>Khác
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="role" id="role" required>
                                            <option value="0" ${account.role==0 ? 'selected' : '' }>Customer</option>
