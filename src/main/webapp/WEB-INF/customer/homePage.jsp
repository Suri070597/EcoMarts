...
<%
    ...
    java.util.Map<Integer, Double> stockQuantityMap = (java.util.Map<Integer, Double>) request.getAttribute("stockQuantityMap");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <section class="product-section" data-aos="fade-up">
                    ...
                    <%
                        if (featuredProducts != null && !featuredProducts.isEmpty()) {
                            for (Product p : featuredProducts) {
                                Double stockQty = stockQuantityMap.getOrDefault(p.getProductID(), 0.0);
                    %>
                    <div class="product-card" data-product-id="<%= p.getProductID()%>" data-stock-quantity="<%= stockQty%>">
                        <% if (stockQty <= 0) { %>
                        ...
                        <div class="product-image-container">
                            ...
                            <div class="product-actions">
                                <button class="action-btn add-to-cart-action" data-product-id="<%= p.getProductID()%>" data-stock-quantity="<%= stockQty%>" <%= stockQty <= 0 ? "disabled style='opacity:0.5;cursor:not-allowed;'" : ""%>><i class="fas fa-cart-plus"></i></button>
                        ...
                        <div class="product-info">
                            ...
                            <div class="button-group">
                                <button class="add-to-cart-btn" data-product-id="<%= p.getProductID()%>" data-stock-quantity="<%= stockQty%>" <%= stockQty <= 0 ? "disabled style='opacity:0.5;cursor:not-allowed;'" : ""%>><i class="fas fa-shopping-cart"></i> Giỏ hàng</button>
                                <form action="<%= request.getContextPath()%>/buy-now" method="post" style="display: inline;"> 
                                    ...
                                    <button type="submit" class="buy-now-btn" <%= stockQty <= 0 ? "disabled style='opacity:0.5;cursor:not-allowed;'" : ""%>>Mua ngay</button> 
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <button id="load-more-featured" class="see-more-btn" data-type="featured" data-target="featured-Products">Xem thêm sản phẩm <i class="fas fa-arrow-right"></i></button>
                    <% } %>
            </section>
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-drink" class="see-more-btn" data-parent="1" data-target="drink-products">Xem thêm sản phẩm <i class="fas fa-arrow-right"></i></button>
                    <% } %>
            </section>
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-milk" class="see-more-btn" data-parent="2" data-target="milk-products">
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-fruit" class="see-more-btn" data-parent="3" data-target="fruit-products">
                    Xem thêm sản phẩm <i class="fas fa-arrow-right"></i>
                </button>
                <% } %>
            </section>
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-snack" class="see-more-btn" data-parent="4" data-target="snack-products">
                    Xem thêm sản phẩm <i class="fas fa-arrow-right"></i>
                </button>
                <% } %>
            </section>
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-baby" class="see-more-btn" data-parent="5" data-target="baby-products">
                    Xem thêm sản phẩm <i class="fas fa-arrow-right"></i>
                </button>
                <% } %>            
            </section>
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <button id="load-more-cosmetic" class="see-more-btn" data-parent="6" data-target="cosmetic-products">
                    Xem thêm sản phẩm <i class="fas fa-arrow-right"></i>
                </button>
                <% }%>            
            </section>
