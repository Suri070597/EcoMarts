...
<html>
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <section class="product-section" data-aos="fade-up">
                ...
                <div class="product-grid">
                    ...
                    %>
                    <div class="product-card" data-product-id="<%= p.getProductID() %>">
                        ...
                        <div class="product-info">
                            ...
                            <div class="button-group">
                                <button class="add-to-cart-btn" data-product-id="<%= p.getProductID() %>"><i class="fas fa-shopping-cart"></i> Giỏ hàng</button>
        ...
        <!-- JavaScript -->
        <script src="${pageContext.request.contextPath}/assets/js/homeJs.js"></script>
