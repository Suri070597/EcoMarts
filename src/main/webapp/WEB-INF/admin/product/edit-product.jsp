        ...
        <div class="container-fluid">
            ...
            <div class="main-content">
                <div class="container">
                    ...
                    <form id="updateForm" method="post" action="${pageContext.request.contextPath}/admin/product?action=update&id=<%= mo.getProductID()%>" enctype="multipart/form-data">
                        <!-- Mã sản phẩm - không cho sửa -->
                        <div class="mb-3">
                        ...
                        <% } else { %>
                        <!-- Form cho sản phẩm thường -->

                        <div class="mb-3">
                            <label class="form-label">Số lượng sản phẩm trong 1 thùng</label>
                            <input type="number" min="1" step="1" class="form-control" name="unitPerBox" 
                                   required value="<%= mo.getUnitPerBox()%>" />
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Đơn vị thùng</label>
                            <input type="text" class="form-control" name="boxUnitName" 
                                   value="<%= mo.getBoxUnitName() != null ? mo.getBoxUnitName() : "thùng"%>" required />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="pDescription" rows="6"><%= mo.getDescription() != null ? mo.getDescription() : ""%></textarea>
                        </div>

                        <!-- Hình ảnh hiện tại -->
                        <div class="mb-3">
                            <label class="form-label">Hình ảnh hiện tại</label><br>
                            <% if (mo.getImageURL() != null && !mo.getImageURL().trim().isEmpty()) { %>
                                <img src="<%= request.getContextPath()%>/ImageServlet?name=<%= mo.getImageURL()%>&t=<%= System.currentTimeMillis()%>&v=<%= Math.random()%>" alt="Current Image" width="100" />
                            <% } else { %>
