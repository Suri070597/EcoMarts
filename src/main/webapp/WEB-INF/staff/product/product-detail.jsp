...
<html>
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" rel="preload" as="script">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                %>
                                                                <div id="more-packs-staff" style="display:none;">
                                                                    <div><%= line %></div>
                                                <%
                                                            } else if (i > showLimit) {
                                                %>
                                                ...
                                                %>
                                                                ...
                                                                <button type="button" class="btn btn-link p-0" onclick="
                                                                    (function(btn){
                                                                        var more = document.getElementById('more-packs-staff');
