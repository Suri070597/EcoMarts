...
public class SupplierServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ManufacturerDAO supplierDAO = new ManufacturerDAO();

        if (action != null) {
            if (action.equals("delete")) {
                try {
                    int id = Integer.parseInt(request.getParameter("id"));
                    boolean result = supplierDAO.deleteManufacturer(id);
                ...
                try {
                    ...
                    boolean result = supplierDAO.updateManufacturerStatus(id, newStatus);
                    if (!result) {
        ...
        if (view != null) {
            switch (view) {
                ...
                case "edit":
                    try {
                        int id = Integer.parseInt(request.getParameter("id"));
                        Manufacturer supplier = supplierDAO.getManufacturerById(id);
                        if (supplier != null) {
                ...
                case "detail":
                    ...
                    Manufacturer supplierDetail = supplierDAO.getManufacturerById(supplierId);
                ...
                default:
                    ...
                    List<Manufacturer> suppliers;
                    if (keyword != null && !keyword.trim().isEmpty()) {
                        suppliers = supplierDAO.searchManufacturers(keyword);
                        request.setAttribute("keyword", keyword);
                    } else {
                        suppliers = supplierDAO.getAllManufacturers();
                    }

                    int totalManufacturers = supplierDAO.countManufacturers();
                    int activeManufacturers = supplierDAO.countManufacturersByStatus(1);
                    int inactiveManufacturers = supplierDAO.countManufacturersByStatus(0);
            ...
            List<Manufacturer> suppliers = supplierDAO.getAllManufacturers();
            int totalManufacturers = supplierDAO.countManufacturers();
            int activeManufacturers = supplierDAO.countManufacturersByStatus(1);
            int inactiveManufacturers = supplierDAO.countManufacturersByStatus(0);
